...
use crate::{color_hex_utils::color_from_hex, CategoryTrait, NodeTemplateIter, NodeTemplateTrait};

use eframe::egui;
use egui::{CollapsingHeader, Frame, Key, Pos2, ScrollArea, Stroke, Ui, vec2};
    ...
    pub fn show(
        ...
        frame.show(ui, |ui| {
            ui.vertical(|ui| {
                ...
                let mut categories: BTreeMap<String, Vec<&NodeTemplate>> = BTreeMap::default();
